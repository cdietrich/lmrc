  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case DbDslPackage.DATABASE:
      {
        ...
        if (result == null) result = caseRoot(database);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      {
        AbstractColumnMapper abstractColumnMapper = (AbstractColumnMapper)theEObject;
        T result = caseAbstractColumnMapper(abstractColumnMapper);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case DbDslPackage.ABSTRACT_DATA_TYPE:
      {
      ...
      case DbDslPackage.CHAR_TYPE:
      {
        ...
        if (result == null) result = caseAbstractDataType(charType);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case DbDslPackage.NUMBER_TYPE:
      {
        ...
        if (result == null) result = caseAbstractDataType(numberType);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
