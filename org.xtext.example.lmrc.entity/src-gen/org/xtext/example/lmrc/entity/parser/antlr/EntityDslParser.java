...
public class EntityDslParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	@Override
	protected org.xtext.example.lmrc.entity.parser.antlr.internal.InternalEntityDslParser createParser(XtextTokenStream stream) {
		return new org.xtext.example.lmrc.entity.parser.antlr.internal.InternalEntityDslParser(stream, getGrammarAccess());
	}
