...
* generated by Xtext
*/
package org.xtext.example.lmrc.entityexpr.ui.contentassist.antlr;
...
public class EntityWithExprDslParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.xtext.example.lmrc.entityexpr.ui.contentassist.antlr.internal.InternalEntityWithExprDslParser createParser() {
		org.xtext.example.lmrc.entityexpr.ui.contentassist.antlr.internal.InternalEntityWithExprDslParser result = new org.xtext.example.lmrc.entityexpr.ui.contentassist.antlr.internal.InternalEntityWithExprDslParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getModuleAccess().getEntitiesAssignment_4(), "rule__Module__EntitiesAssignment_4");
					...
					put(grammarAccess.getEntityAccess().getOperationsAssignment_4(), "rule__Entity__OperationsAssignment_4");
					...
					put(grammarAccess.getOperationAccess().getBodyAssignment_5(), "rule__Operation__BodyAssignment_5");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.xtext.example.lmrc.entityexpr.ui.contentassist.antlr.internal.InternalEntityWithExprDslParser typedParser = (org.xtext.example.lmrc.entityexpr.ui.contentassist.antlr.internal.InternalEntityWithExprDslParser) parser;
