...
/**
 * Manual modifications go to {org.xtext.example.lmrc.entityexpr.EntityWithExprDslRuntimeModule}
 */
 @SuppressWarnings("all")
public abstract class AbstractEntityWithExprDslRuntimeModule extends DefaultRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/xtext/example/lmrc/entityexpr/EntityWithExprDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.xtext.example.lmrc.entityexpr.EntityWithExprDsl");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("entityexpr");
	}
	
	// contributed by org.eclipse.xtext.generator.grammarAccess.GrammarAccessFragment
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return org.xtext.example.lmrc.entityexpr.services.EntityWithExprDslGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISemanticSequencer> bindISemanticSequencer() {
		return org.xtext.example.lmrc.entityexpr.serializer.AbstractEntityWithExprDslSemanticSequencer.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISyntacticSequencer> bindISyntacticSequencer() {
		return org.xtext.example.lmrc.entityexpr.serializer.AbstractEntityWithExprDslSyntacticSequencer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return org.xtext.example.lmrc.entityexpr.parser.antlr.EntityWithExprDslParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return org.xtext.example.lmrc.entityexpr.parser.antlr.EntityWithExprDslAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return org.xtext.example.lmrc.entityexpr.parser.antlr.internal.InternalEntityWithExprDslLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<org.xtext.example.lmrc.entityexpr.parser.antlr.internal.InternalEntityWithExprDslLexer> provideInternalEntityWithExprDslLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(org.xtext.example.lmrc.entityexpr.parser.antlr.internal.InternalEntityWithExprDslLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(org.xtext.example.lmrc.entityexpr.parser.antlr.internal.InternalEntityWithExprDslLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends org.xtext.example.lmrc.entityexpr.validation.EntityWithExprDslJavaValidator> bindEntityWithExprDslJavaValidator() {
		return org.xtext.example.lmrc.entityexpr.validation.EntityWithExprDslJavaValidator.class;
	}
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return org.xtext.example.lmrc.entityexpr.formatting.EntityWithExprDslFormatter.class;
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return org.xtext.example.lmrc.entityexpr.jvmmodel.EntityWithExprDslJvmModelInferrer.class;
	}
