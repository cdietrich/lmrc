...
import org.xtext.example.lmrc.entityexpr.entityWithExprDsl.EntityWithExprDslFactory;
 ...
 * @generated
 */
public class EntityWithExprDslPackageImpl extends EPackageImpl implements EntityWithExprDslPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.lmrc.entityexpr.entityWithExprDsl.EntityWithExprDslPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private EntityWithExprDslPackageImpl()
  {
    super(eNS_URI, EntityWithExprDslFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link EntityWithExprDslPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static EntityWithExprDslPackage init()
  {
    if (isInited) return (EntityWithExprDslPackage)EPackage.Registry.INSTANCE.getEPackage(EntityWithExprDslPackage.eNS_URI);

    // Obtain or create and register package
    EntityWithExprDslPackageImpl theEntityWithExprDslPackage = (EntityWithExprDslPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof EntityWithExprDslPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new EntityWithExprDslPackageImpl());
    ...
    theEntityWithExprDslPackage.createPackageContents();

    // Initialize created meta-data
    theEntityWithExprDslPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theEntityWithExprDslPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(EntityWithExprDslPackage.eNS_URI, theEntityWithExprDslPackage);
    return theEntityWithExprDslPackage;
  }
   ...
   * @generated
   */
  public EntityWithExprDslFactory getEntityWithExprDslFactory()
  {
    return (EntityWithExprDslFactory)getEFactoryInstance();
  }
