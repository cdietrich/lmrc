 ...
 * <ul>
 *   <li>{@link org.xtext.example.lmrc.uispec.uispecDsl.impl.ComboWidgetImpl#getValues <em>Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ComboWidgetImpl extends WidgetImpl implements ComboWidget
{
  ...
  {
    return UispecDslPackage.Literals.COMBO_WIDGET;
  }
  ...
  public EList<String> getValues()
  {
    if (values == null)
    {
      values = new EDataTypeEList<String>(String.class, this, UispecDslPackage.COMBO_WIDGET__VALUES);
    }
    return values;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case UispecDslPackage.COMBO_WIDGET__VALUES:
        return getValues();
    }
